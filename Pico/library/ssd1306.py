...
class SSD1306:
    ...
    def init_display(self):
        ...
        # Important:
        # Do NOT call self.show() here.
        # Through a PCA9548A, that big write can fail during SSD1306_I2C(...) creation.
        self.fill(0)
...
class SSD1306_I2C(SSD1306):
    ...
    def write_data(self, buf):
        ...
        for i in range(0, len(buf), chunk_size):
            self.i2c.writeto(self.addr, b'\x40' + buf[i:i + chunk_size])
            time.sleep_ms(1)
